...
mod main_window {
	use gui::{
		...
		cursor, display, icon, menu, rich_edit,
		wide_string::ToWide,
	...
	use windows::Win32::{
		...
		UI::WindowsAndMessaging::{
			...
			EnumChildWindows, GetClientRect, GetMessageW, LoadCursorW, LoadIconW, MoveWindow,
			PostQuitMessage, RegisterClassExW, SetMenu, ShowWindow, TranslateMessage, COLOR_WINDOW,
			MSG, WNDCLASSEXW,
		},
	};
